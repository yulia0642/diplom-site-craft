...
const routes = [
  ...
  },
  {
    ...
    description: "Идеальное первое знакомство с Японией: от футуристического Токио с небоскрёбами Синдзюку и неоновым Акихабарой до традиционного Киото с гейшами и бамбуковыми рощами. Исследуйте гастрономическую Осаку (такояки, окономияки, кусикацу), посетите мемориал мира в Хиросиме и священный остров Миядзима с плавучими тории. Включены дегустации сакэ, посещение рыбного рынка Цукидзи, прогулки по Гиону и Арасияме. JR Pass обеспечит комфортные переезды на синкансэн между городами.",
    duration: "14 дней",
    difficulty: "Легкий",
    budget: "200-350 тыс. ₽",
  ...
  },
  {
    ...
    description: "Япония для всей семьи: Tokyo Disneyland и DisneySea, студия Ghibli, интерактивные музеи науки и технологий, аквариумы мирового класса. Посещение замка Химэдзи, кормление оленей в Наре, поездка на поезде-панде в Вакаяме. Удобные семейные отели с просторными номерами, рестораны с детским меню, запланированные перерывы для отдыха. Познавательные и развлекательные активности: изготовление суши, мастер-классы по оригами и кимоно, игры в традиционные японские игрушки. Комфортный темп без ранних подъёмов и долгих переездов.",
    duration: "12 дней",
    difficulty: "Легкий",
    budget: "250-400 тыс. ₽",
  ...
  },
  {
    image: photoImage,
    title: "Фотосафари",
    description: "Специально разработанный маршрут для фотографов и визуальных художников. Ловите золотой час на фоне горы Фудзи, снимайте красные тории Фусими Инари в утреннем тумане, запечатлейте гейш в переулках Гиона на закате. Сезон момидзи (осенних клёнов) в храмах Киото, цветение сакуры в парке Уэно, бамбуковая роща Арасиямы в дневном свете. Малые группы обеспечивают гибкость маршрута, ранние выезды к рассвету, вечерние съёмки ночной иллюминации. Получите все необходимые разрешения, профессиональные советы по локациям и композиции.",
    duration: "9 дней",
    difficulty: "Средний",
    budget: "200-320 тыс. ₽",
