...
const routes = [
  ...
  },
  {
    ...
    description: "Идеальное первое знакомство с Японией: от футуристического Токио с небоскрёбами Синдзюку и неоновым Акихабарой до традиционного Киото с гейшами и бамбуковыми рощами. Исследуйте гастрономическую Осаку, посетите мемориал мира в Хиросиме и священный остров Миядзима с плавучими тории. Включены дегустации сакэ, посещение рыбного рынка Цукидзи, прогулки по Гиону и Арасияме. JR Pass обеспечит комфортные переезды на синкансэн между городами.",
    duration: "14 дней",
    difficulty: "Легкий",
    budget: "200-350 тыс. ₽",
