...
const Index = () => {
  const benefits = [
    ...
    },
    {
      icon: Users,
      title: "Сообщество",
      description: "Объединяем людей, интересующихся Японией, ее языком и культурой"
    },
    {
      icon: Globe,
            ...
            <Card className="overflow-hidden hover-lift animate-fade-up">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  Сады камней, чайные церемонии и искусство каллиграфии — все это пути к внутреннему спокойствию
                </p>
              </CardContent>
            </Card>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              {[
                ...
                },
                {
                  ...
                  details: ["Весна: цветение сакуры", "Лето: фестивали мацури", "Осень: момидзи (клены)", "Зима: снежные пейзажи"],
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {[
              ...
              },
              {
                ...
                items: ["Новый год (Сегацу)", "Ханами (сакура)", "Обон", "Момидзи-гари"],
                badge: "Традиции"
              },
              {
                icon: Building2,
                title: "Архитектура",
                subtitle: "建築 Кэнтику",
                items: ["Традиционные храмы", "Современные небоскребы", "Сады", "Минимализм"],
                badge: "Гармония"
              },
              {
                icon: Heart,
            ...
            {[
              {
                number: "6852",
                label: "островов",
                description: "составляют Японский архипелаг, хотя большинство населения живет на четырех главных островах"
              },
              {
                number: "3000+",
                label: "иероглифов",
              ...
              },
              {
                number: "127 млн",
                label: "жителей",
                description: "проживает в Японии, одной из самых густонаселенных стран мира"
              }
            ].map((fact, index) => (
              <Card 
                key={index}
      ...
      <section className="py-20 relative overflow-hidden bg-transparent ambient-section">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16 animate-fade-up">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Момидзи — это медийная платформа для всех, кто увлечен Японией, ее культурой и языком. 
              Мы создаем контент, который помогает глубже понять и прочувствовать японскую культуру
            </p>
          </div>
